let e;var t="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},a={},r={},n=t.parcelRequireaf4f;null==n&&((n=function(e){if(e in a)return a[e].exports;if(e in r){var t=r[e];delete r[e];var n={id:e,exports:{}};return a[e]=n,t.call(n.exports,n,n.exports),n.exports}var i=Error("Cannot find module '"+e+"'");throw i.code="MODULE_NOT_FOUND",i}).register=function(e,t){r[e]=t},t.parcelRequireaf4f=n),n("eGLeC");const i="Server could not be reached.",s=function(e){let t=document.createElement("header");return t.innerHTML=`
...
<div style="background-color: #${e.PrimaryColor}" class="primary-color"></div>
  ...
  `));let s=document.createElement("div");s.classList.add("team-roster-container"),s.appendChild(a),s.appendChild(n),t.appendChild(s)}else{let a=document.createElement("div");a.classList.add("error-container"),a.insertAdjacentHTML("afterbegin",e),t.insertAdjacentElement("afterbegin",a)}return t},u=function(e){return`
      <h3>REQUEST ERROR</h3>
      <p>${e}</p>
      `},h=async function(e){try{let t=await fetch(`https://api.weatherapi.com/v1/current.json?key=6e08ab4df3fa41fb8e690211230808&q=${e.StadiumDetails.GeoLat},${e.StadiumDetails.GeoLong}`),a=await t.json();return console.log(a),a}catch(e){return console.error(e),"Weather API Server could not be reached."}},m=async function(e){try{let t=await fetch(`https://api.sportsdata.io/v3/nfl/scores/json/Players/${e}?key=ffb7852aadbe4662a351fad874b411ce`),a=await t.json();return a}catch(e){return console.error(e),u("Team Players server could not be reached.")}},p=async function(e){try{let t=await fetch("https://api.sportsdata.io/v3/nfl/scores/json/Teams?key=ffb7852aadbe4662a351fad874b411ce"),a=await t.json(),r=a.find(t=>t.Key===e);document.title=`${r.FullName}`;let n=await m(e),i=document.createElement("main"),d=s(r),u=c(),h=o(r),p=l(n);return u.addEventListener("click",function(e){"team-info"===e.target.dataset.btn&&(p.classList.add("hidden"),h.classList.remove("hidden"),h.scrollIntoView({behavior:"smooth"})),"team-roster"===e.target.dataset.btn&&(h.classList.add("hidden"),p.classList.remove("hidden"),p.scrollIntoView({behavior:"smooth"}))}),i.appendChild(d),i.appendChild(u),i.appendChild(h),i.appendChild(p),[i,r]}catch(a){console.error(a);let e=document.createElement("main"),t=document.createElement("div");return t.classList.add("error-container"),t.insertAdjacentHTML("afterbegin",u(i)),e.appendChild(t),e}},f=window.location.search,v=new URLSearchParams(f);v.has("key")?console.log(e=v.get("key")):window.location.href="../index.html",window.addEventListener("DOMContentLoaded",function(t){p(e).then(e=>{if(console.log(e),!Array.isArray(e))throw document.body.appendChild(e),Error(i);return document.body.appendChild(e[0]),h(e[1])}).then(e=>{let t=this.document.querySelector("#stadium-weather");e.hasOwnProperty("current")||e.hasOwnProperty("location")?t.textContent=`${e.current.temp_c}\xbaC and ${e.current.condition.text}`:t.textContent=e}).catch(e=>console.error(e))});//# sourceMappingURL=team-stats-information.8f8642e7.js.map

//# sourceMappingURL=team-stats-information.8f8642e7.js.map
